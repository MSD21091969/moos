...
// GraphState is the carrier algebra — the current materialized state.
// Nodes map is Ob(C); Wires map is Hom(C).
// This state is always reconstructible from the morphism log via catamorphism.
