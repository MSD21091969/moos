...
| `.agent/knowledge/superset/ontology_v3.json` | `superset/ontology.json` | planned | Structured canonical registry source |
| `.agent/knowledge/superset/ontology_v3.csv` | `superset/ontology.csv` | planned | Derivative export source |
