...
- **Tech Stack**: Nx 22, React 19, Vite 7, TypeScript 5.9, TailwindCSS 4.
- **State Management**: Zustand (morphism-driven stores).
- **Graph Visualization**: @xyflow/react (XYFlow).
- **Testing**: Vitest 4, jsdom environment (22 tests in ffs4).
...
- Test (ffs4): `pnpm nx test ffs4` — 22 vitest tests (graphStore morphisms + edge cases)
