...
See **[architecture/_index.md](architecture/_index.md)** for the full index and reading order.
...
**NodeContainer**: 8-field workspace structure (manifest, instructions, rules, skills, tools, knowledge, workflows, configs). Isomorphic to `.agent/` folder on disk.
...
**Workspace-Driven**: Applications are defined by `.agent/` metadata in workspace directories. FFS4-8 packages provide domain-specific viewers. Backend context determines which frontend to load.
